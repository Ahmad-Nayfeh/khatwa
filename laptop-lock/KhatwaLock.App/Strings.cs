...
internal sealed class Strings
{
    ...
    public static readonly Strings Ar = new()
    {
        ...
        PairHint = "في تطبيق خطوة على الجوال: الإعدادات ← قفل اللابتوب (أو زر «اقتران اللابتوب» عند أول قفل). اكتب هنا كود الاقتران المكوّن من 8 أرقام.",
        PairPlaceholder = "0000 0000",
        PairButton = "اقتران",
        PairBad = "كود الاقتران غير صحيح. يتكون من 8 أرقام.",
        PairedTitle = "اللابتوب مقترن بجوالك",
        LockHint = "اقفل جوالك من تطبيق خطوة، ثم اكتب هنا «كود قفل اللابتوب» (6 أرقام) الظاهر في الرئيسية. يُقفل اللابتوب فور كتابة الرقم السادس.",
        LockPlaceholder = "000 000",
        LockButton = "قفل اللابتوب",
        LockBad = "الكود لا يطابق جوالك. اكتب الكود الظاهر في بطاقة القفل النشط في رئيسية الجوال.",
    ...
    public static readonly Strings En = new()
    {
        ...
        PairHint = "In the khatwa app on your phone: Settings → Laptop lock (or \"Pair laptop\" on the first lock). Type the 8-digit pairing code here.",
        PairPlaceholder = "0000 0000",
        PairButton = "Pair",
        PairBad = "That pairing code is not valid. It has 8 digits.",
        PairedTitle = "This laptop is paired with your phone",
        LockHint = "Lock your phone in the khatwa app, then type the 6-digit \"laptop lock code\" shown on its home screen. The laptop locks as soon as you type the last digit.",
        LockPlaceholder = "000 000",
        LockButton = "Lock this laptop",
        LockBad = "That code does not match your phone. Type the code shown on the active-lock card on the phone's home screen.",
