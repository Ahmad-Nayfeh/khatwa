...
internal sealed class Strings
{
    ...
    public static readonly Strings Ar = new()
    {
        ...
        PairTitle = "الخطوة 1 من 2: الاقتران (مرة واحدة فقط)",
        PairHint = "في تطبيق خطوة على الجوال: الإعدادات ← قفل اللابتوب ← «كود الاقتران» (8 أرقام). اكتبه هنا. لن تحتاجه مرة أخرى.",
        PairPlaceholder = "0000 0000",
        PairButton = "اقتران",
        PairBad = "هذا ليس كود الاقتران. راجع الأرقام الثمانية في الجوال (الإعدادات ← قفل اللابتوب) واكتبها مرة أخرى. إن تكرر الرفض فولّد كوداً جديداً في الجوال.",
        PairedTitle = "الخطوة 2: قفل اللابتوب",
        LockHint = "اللابتوب مقترن بجوالك.\nاقفل جوالك من تطبيق خطوة، فيظهر في الرئيسية «كود قفل اللابتوب» (6 أرقام). اكتبه هنا فيُقفل اللابتوب فوراً.",
        LockPlaceholder = "000 000",
        LockButton = "قفل اللابتوب",
        LockBad = "الكود لا يطابق جوالك. اكتب الكود الظاهر الآن في رئيسية الجوال.\nإن ولّدت كود اقتران جديداً في الجوال، اضغط «إلغاء الاقتران» هنا واقترن من جديد.",
        ...
        LockScreenSubtitle = "عند اكتمال التحدي يعرض الجوال «كود فتح اللابتوب» (6 أرقام). اكتبه هنا فيُفتح فوراً.",
        UnlockButton = "فتح",
        ...
        EmergencyType = "اكتب هذه الجملة (بلا علامات تنصيص؛ التشكيل والهمزات لا تهم):\n{0}",
        Continue = "متابعة",
    ...
    public static readonly Strings En = new()
    {
        ...
        PairTitle = "Step 1 of 2: pair (only once)",
        PairHint = "In the khatwa app on your phone: Settings → Laptop lock → \"Pairing code\" (8 digits). Type it here. You won't need it again.",
        PairPlaceholder = "0000 0000",
        PairButton = "Pair",
        PairBad = "That is not the pairing code. Check the 8 digits on the phone (Settings → Laptop lock) and type them again. If it keeps failing, make a new code on the phone.",
        PairedTitle = "Step 2: lock this laptop",
        LockHint = "Paired with your phone.\nLock your phone in the khatwa app; its home screen then shows a 6-digit \"laptop lock code\". Type it here and the laptop locks at once.",
        LockPlaceholder = "000 000",
        LockButton = "Lock this laptop",
        LockBad = "That code does not match your phone. Type the code shown now on the phone's home screen.\nIf you made a new pairing code on the phone, click \"Unpair\" here and pair again.",
        ...
        LockScreenSubtitle = "When the challenge is complete, the phone shows the 6-digit \"laptop unlock code\". Type it here and the laptop unlocks.",
        UnlockButton = "Unlock",
        ...
        EmergencyType = "Type this sentence (no quote marks; capitals and punctuation don't matter):\n{0}",
        Continue = "Continue",
